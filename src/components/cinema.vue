		...
		<div class="body" style="display: block;">
			...
			<div class="topbar">
				<div class="white-bg topbar-bg ">
					...
					<div class="city-entry">
						<span class="city-name" @click="$router.push('/cityList')">北京</span><i class="city-entry-arrow"></i>
					</div>
					<!-- 搜索按钮 -->
					<div class="search-entry search-input" data-type="cinema">
						<img src="data:image/png;base64,"
						 alt="">
						<span  @click="$router.push('/search')">搜影院</span>
					</div>
				</div>
			</div>
			...
			<div class="cinema-list" data-cid="c_5ovvtlp2" style="margin-bottom: 55px;">
				<div class="list-wrap" style="margin-top: 0px; min-height: 528px;">
					<div v-for="(item,index) in cinemas" 
					:key="index"
					class="item mb-line-b" data-id="24963" 
					data-bid="dp_wx_home_cinema_list"
					>
						<div class="title-block box-flex middle"  
						@click="$router.push('/shows/'+item.id+'/'+item.nm)">
