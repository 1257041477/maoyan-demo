      ...
      <div class="select-block" style="height: 321.234px;">
        <div class="seat-block-wrap" style="visibility: visible;" v-if="seatData.seat">
            ...
            <div class="hall-name-wrapper animate" style="transform: translate3d(108.5px, 0px, 0px) scale(1, 1) rotate3d(0, 0, 0, 0deg);">
              <span class="hall-name">巨幕10厅</span>
            </div>
             <!-- 侧边排号 -->
            <div class="row-nav animate" style="transform: translate3d(-0.8px, -92.3905px, 0px) scale(0.9, 0.9) rotate3d(0, 0, 0, 0deg);">          
              <div>1</div>          
              <div>2</div>          
              <div></div>         
              <div>3</div>        
...
export default {
  ...
  created() {
     this.$store.commit("setNavTitle", "选座");
